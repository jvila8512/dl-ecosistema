...
class UsuarioEcosistemaResourceIT {
    ...
    public static UsuarioEcosistema createEntity(EntityManager em) {
        UsuarioEcosistema usuarioEcosistema = new UsuarioEcosistema().nombre(DEFAULT_NOMBRE);
    ...
    public static UsuarioEcosistema createUpdatedEntity(EntityManager em) {
        UsuarioEcosistema usuarioEcosistema = new UsuarioEcosistema().nombre(UPDATED_NOMBRE);
        return usuarioEcosistema;
    }
    ...
    void createUsuarioEcosistema() throws Exception {
        ...
        assertThat(testUsuarioEcosistema.getNombre()).isEqualTo(DEFAULT_NOMBRE);
    }
    ...
    void checkNombreIsRequired() throws Exception {
        ...
        // set the field null
        usuarioEcosistema.setNombre(null);
    ...
    void putNewUsuarioEcosistema() throws Exception {
        ...
        updatedUsuarioEcosistema.nombre(UPDATED_NOMBRE);
        ...
        UsuarioEcosistema testUsuarioEcosistema = usuarioEcosistemaList.get(usuarioEcosistemaList.size() - 1);
        assertThat(testUsuarioEcosistema.getNombre()).isEqualTo(UPDATED_NOMBRE);
    }
    ...
    void partialUpdateUsuarioEcosistemaWithPatch() throws Exception {
        ...
        partialUpdatedUsuarioEcosistema.nombre(UPDATED_NOMBRE);
