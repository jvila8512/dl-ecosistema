...
class IdeaResourceIT {
    ...
    private static final LocalDate DEFAULT_FECHA_INCRIPCION = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_FECHA_INCRIPCION = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Idea createEntity(EntityManager em) {
        Idea idea = new Idea()
            ...
            .autor(DEFAULT_AUTOR)
            .fechaIncripcion(DEFAULT_FECHA_INCRIPCION);
        return idea;
    }
    ...
    public static Idea createUpdatedEntity(EntityManager em) {
        Idea idea = new Idea()
            ...
            .autor(UPDATED_AUTOR)
            .fechaIncripcion(UPDATED_FECHA_INCRIPCION);
        return idea;
    }
    ...
    void createIdea() throws Exception {
        ...
        assertThat(testIdea.getEntidad()).isEqualTo(DEFAULT_ENTIDAD);
        ...
        assertThat(testIdea.getFechaIncripcion()).isEqualTo(DEFAULT_FECHA_INCRIPCION);
    }
    ...
    void getAllIdeas() throws Exception {
        ...
        restIdeaMockMvc
            ...
            .andExpect(jsonPath("$.[*].fechaIncripcion").value(hasItem(DEFAULT_FECHA_INCRIPCION.toString())));
    }
    ...
    void getIdea() throws Exception {
        ...
        restIdeaMockMvc
            ...
            .andExpect(jsonPath("$.fechaIncripcion").value(DEFAULT_FECHA_INCRIPCION.toString()));
    }
    ...
    void putNewIdea() throws Exception {
        ...
        assertThat(testIdea.getEntidad()).isEqualTo(UPDATED_ENTIDAD);
        ...
        assertThat(testIdea.getFechaIncripcion()).isEqualTo(UPDATED_FECHA_INCRIPCION);
    }
