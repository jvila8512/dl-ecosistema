...
public class TipoIdeaResource {
    ...
    public ResponseEntity<TipoIdea> createTipoIdea(@RequestBody TipoIdea tipoIdea) throws URISyntaxException {
    ...
    public List<TipoIdea> getAllTipoIdeas(@RequestParam(required = false) String filter) {
        if ("idea-is-null".equals(filter)) {
            log.debug("REST request to get all TipoIdeas where idea is null");
            return tipoIdeaService.findAllWhereIdeaIsNull();
        }
