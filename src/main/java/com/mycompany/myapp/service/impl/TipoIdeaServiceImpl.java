...
public class TipoIdeaServiceImpl implements TipoIdeaService {
    ...
    /**
     *  Get all the tipoIdeas where Idea is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<TipoIdea> findAllWhereIdeaIsNull() {
        log.debug("Request to get all tipoIdeas where Idea is null");
        return StreamSupport
            .stream(tipoIdeaRepository.findAll().spliterator(), false)
            .filter(tipoIdea -> tipoIdea.getIdea() == null)
