    ...
    <Row>
      <Col md="8">
        <h2 data-cy="usuarioEcosistemaDetailsHeading">
          <Translate contentKey="jhipsterApp.usuarioEcosistema.detail.title">UsuarioEcosistema</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{usuarioEcosistemaEntity.nombre}</dd>
          <dt>
          ...
          <dd>{usuarioEcosistemaEntity.ecosistema ? usuarioEcosistemaEntity.ecosistema.nombre : ''}</dd>
        </dl>
        <Button tag={Link} to="/usuario-ecosistema" replace color="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button tag={Link} to={`/usuario-ecosistema/${usuarioEcosistemaEntity.id}/edit`} replace color="primary">
