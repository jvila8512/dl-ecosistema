    ...
    <div>
      <h2 id="tipo-idea-heading" data-cy="TipoIdeaHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/tipo-idea/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
        ...
        {tipoIdeaList && tipoIdeaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jhipsterApp.tipoIdea.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {tipoIdeaList.map((tipoIdea, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  <td>
                    <Button tag={Link} to={`/tipo-idea/${tipoIdea.id}`} color="link" size="sm">
                      {tipoIdea.id}
                    </Button>
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/tipo-idea/${tipoIdea.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/tipo-idea/${tipoIdea.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`/tipo-idea/${tipoIdea.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
