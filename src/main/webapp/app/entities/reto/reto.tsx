    ...
    <div>
      <h2 id="reto-heading" data-cy="RetoHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/reto/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            <tbody>
              {retoList.map((reto, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{reto.ecosistema ? <Link to={`/ecosistema/${reto.ecosistema.id}`}>{reto.ecosistema.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/reto/${reto.id}`} color="info" size="sm" data-cy="entityDetailsButton">
                      ...
                      <Button
                        tag={Link}
                        to={`/reto/${reto.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        tag={Link}
                        to={`/reto/${reto.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
